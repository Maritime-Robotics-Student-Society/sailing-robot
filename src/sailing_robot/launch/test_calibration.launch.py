"""
ROS 2 launch file for calibration testing (all hardware sensors).

Equivalent to the ROS 1 test-calibration.launch file.
"""
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package='sailing_robot',
            executable='sensor_driver_multiplexer',
            name='sensor_driver_multiplexer',
            parameters=shared_params,
            respawn=True,
        ),
        Node(
        ...
        Node(
            package='sailing_robot',
            executable='sensor_driver_battery',
            name='sensor_driver_battery',
            parameters=shared_params,
        ),
        Node(
            package='sailing_robot',
